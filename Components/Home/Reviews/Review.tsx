...
const Review: React.FC = () => {
  return (
    <div className="max-w-[1200px] m-auto ">
      ...
      <p className="text-black max-w-[311px] font-inter text-base font-normal leading-6 underline m-auto">Give us a Call 1-888-498-9240 and we can set you up, or check our pricing plans</p>
      </div>
    </div>
  );
};
